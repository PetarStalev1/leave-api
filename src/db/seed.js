...
const leave = db.prepare(`
    INSERT INTO leave_requests (user_id, start_date, end_date, leave_type, status, working_days, approved_by, updated_at)   
    VALUES (?,?,?,?,?,?,?, datetime('now'))
`)

leave.run(ivan.lastInsertRowid, '2026-01-06', '2026-01-10', 'annual', 'approved', 5, manager.lastInsertRowid)
leave.run(ivan.lastInsertRowid, '2026-06-01', '2026-06-05', 'annual', 'pending',  5, null)

leave.run(elena.lastInsertRowid, '2026-02-10', '2026-02-12', 'sick',   'approved', 3, manager.lastInsertRowid)
leave.run(elena.lastInsertRowid, '2026-07-14', '2026-07-18', 'annual', 'pending',  5, null)


leave.run(georgi.lastInsertRowid, '2026-03-16', '2026-03-20', 'unpaid', 'approved', 5, manager.lastInsertRowid)
